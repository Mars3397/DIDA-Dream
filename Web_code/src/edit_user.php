...
<body>
          ...
          <div class="modal-dialog">
              ...
              <form action="edit_shop.php" method="post"> 
                  ...
                  <div class="form-group">
                      <label class="control-label " for="new_name">店家名稱</label>
                      <input type="text" class="form-control input" id="new_name" placeholder="輸入新的店家名稱" name="new_name">
                  </div>
                  <div class="form-group">
                      <label class="control-label " for="new_type">店家類別</label>
                  ...
                  <div class="form-group">
                      <label class="control-label " for="new_address">店家地址</label>
                  ...
                  <form action="edit_user_php.php" method="post">
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" style="border-bottom: 1px solid #fffae3;" class="form-control input" id="u_address" autocomplete="off" name="address" placeholder="輸入地址">
  ...
  <script
	...
	<script>
		$(document).ready(function() {
			$('#new_shop_address').keyup(function() {
			...
			$('#u_address').keyup(function() {
				...
				if (address != '') {
					...
					geocoder.geocode( { 'address': address}, function(results, status) {
						if (status == 'OK') {
							console.log(results[0]);
							$('#u_lat').val(results[0].geometry.location.lat());
							$('#u_lon').val(results[0].geometry.location.lng());
						}
					});
				}
			});
